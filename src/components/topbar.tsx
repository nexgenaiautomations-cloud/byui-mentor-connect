    ...
    <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-white/15 bg-transparent px-4 lg:px-10">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <Link
          href="/profile"
          aria-label="Profile"
          className="grid h-10 w-10 place-items-center overflow-hidden rounded-full bg-white/10 text-xs font-semibold text-white cursor-pointer ring-2 ring-white/30"
        >
          {user.image ? (
